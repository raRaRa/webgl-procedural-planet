...
TerrainPatch.prototype.createMesh = function() {
	...
	//console.log(this.centerPos, this.cubePosition.z, this.cubePosition.y, this.cubePosition.x);
...
TerrainPatch.prototype.addSpherePoint = function(x, y, z) {
	...
	/*if (this.position == null) {
		this.position = spherePoint;
	}
*/

	if (DEBUG_WORLDSPACE) {
		this.centerPos = Vec3.fromValues(0, 0, 0);
	}

	this.vertices.push( spherePoint.x - this.centerPos.x, spherePoint.y - this.centerPos.y, spherePoint.z - this.centerPos.z );
	//this.normals.push( spherePoint.x, spherePoint.y, spherePoint.z);
